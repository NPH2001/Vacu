...
Expected: a new file `drizzle/0001_<slug>.sql` (or next sequential number) is created containing `CREATE TABLE "menu_items" (...)`. Inspect it briefly — it should have an `id serial PK`, `location text NOT NULL CHECK (location IN ('header','footer'))`, `label text NOT NULL`, `href text NOT NULL`, `open_in_new_tab bool NOT NULL DEFAULT false`, `sort_order int NOT NULL DEFAULT 0`.
